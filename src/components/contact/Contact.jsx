  ...
  return (
    <section className="rounded-3xl border border-base-content/10 bg-base-100 px-5 py-10 shadow-sm sm:px-8 lg:px-10">
      ...
      <div className="grid items-start gap-6 xl:grid-cols-[0.85fr_1.15fr]">
        <div className="rounded-2xl border border-base-content/10 bg-base-200/60 p-5 sm:p-6">
          <div>
          ...
          <div className="mt-6 grid gap-3">
            {contactInfo.map((item) => {
              ...
              const Inner = (
                <div className="flex items-center gap-4 rounded-xl border border-base-content/10 bg-base-100 p-4 transition-colors duration-200 hover:border-primary/20">
            ...
            <div className="grid grid-cols-2 gap-2">
              {socialLinks.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl border border-base-content/10 bg-base-100 p-3 transition-colors duration-200 hover:border-primary/30 hover:text-primary"
                >
