            ...
            <ul className="timeline timeline-vertical timeline-snap-icon mt-4 max-md:timeline-compact">
              <li className="intersect-once intersect:motion-preset-bounce">
                ...
                <div className="timeline-start mb-10 md:text-end">
                  ...
                  <div className="mb-2">
                    Our first day in Manila was a deep dive into the heart of
                    the Philippines' heritage. From the cobblestone streets of
                    Intramuros to the grandeur of Manila Cathedral and the
                    solemn beauty of Rizal Park, every stop offered a glimpse
                    into the nation's rich past. We capped the day with a
                    stunning sunset view at the Mall of Asia.
                  </div>
                  <Link to="/blog1">
                    <BlogsBtn />
                  </Link>
              ...
              <li className="intersect-once intersect:motion-preset-bounce">
                ...
                <div className="timeline-end md:mb-10">
                  ...
                  <div className="mb-2">
                    On Day 4, we witnessed the inner workings of national
                    finance and modern technology. At Bangko Sentral ng
                    Pilipinas, we learned about the country’s monetary system
                    and security features in currency. Later, Hytec Power Inc.
              ...
              <li className="intersect-once intersect:motion-preset-bounce">
                ...
                <div className="timeline-start mb-10 md:text-end">
                  ...
                  <div className="mb-2">
                    ...
                    keeps people moving. We visited the Traffic Engineering
                    Center to understand how the city manages traffic flow, then
              ...
              <li className="intersect-once intersect:motion-preset-bounce">
                ...
                <div className="timeline-end md:mb-10">
                  ...
                  <div className="mb-2">
                    ...
                    witnessing the discipline at the Philippine Military
                    Academy, Day 6 was unforgettable. We also explored iconic
                    spots like Mines View Park, Wright Park, The Mansion,
